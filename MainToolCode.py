...
while(True):
    ...
    if(user_inp=='1'):
        exit_flag=ApproximateComputingVerilog.runVerilog();         # Verilog Code Generator
    elif(user_inp=='2'):
        exit_flag=ApproximateComputingError.runError();             # Error Analysis ( MAE and RMSE Calculation )
    elif(user_inp=='3'):
        exit_flag=ApproximateComputingAccuracy.runAccuracy();       # Accuracy Analysis Based on user inputs
