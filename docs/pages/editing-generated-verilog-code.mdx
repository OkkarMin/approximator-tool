...
<Callout emoji="⚠️">
  ...
  verilog code. This edit in only **required for ASIC based designs only**. We
  are working to fix it
</Callout>

## Adder Generated Verilog Code Manual Change

[Adder verilog code generated using the tool](/gui-tool/verilog-code-generator#adder-verilog-code-generator) will look like below (width and size depends upon chosen options)
...
[Multiplier verilog code generated using the tool](/gui-tool/verilog-code-generator#multiplier-verilog-code-generator-asic-verilog-multiplier) will look like below (width and size depends upon chosen options)
