...
2.  V-cut (only for MxN PAAM01 with V-cut)

    - Default Options `3`
    - Constraints: `0 <= v_cut <= multiplicand_bits`

3.  Type of hardware module to generate, chose one of `[MxN Accurate Multiplier, MxN Accurate Binary Array Multiplier, MxN PAAM01 with V-cut]`
