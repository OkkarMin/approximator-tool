...
3. Two unsigned decimal numbers to be multiplied using accurate multiplier and compared against MxN PAAM01 with V-cut for accuracy
...
4. Type of hardware module to analyse accuracy
   ...
   - Default Options: `MxN PAAM01 with V=cut`
