    ...
    if(tot_num_bits<=10):
        ...
        for num1 in range(2**tot_num_bits):
            for num2 in range(2**tot_num_bits):
                accurate_sum=ApproxAdders.accurate_adder(num1,num2,tot_num_bits);
                HEAA_estimate_sum=ApproxAdders.HEAA_approx(num1,num2,tot_num_bits,inaccurate_bits);
...
def HOERAA(tot_num_bits,inaccurate_bits):
    ...
    if(tot_num_bits<=10):
        ...
        for num1 in range(2**tot_num_bits):
            for num2 in range(2**tot_num_bits):
                accurate_sum=ApproxAdders.accurate_adder(num1,num2,tot_num_bits);
                HOERAA_estimate_sum=ApproxAdders.HOERAA_approx(num1,num2,tot_num_bits,inaccurate_bits);
...
def HOAANED(tot_num_bits,inaccurate_bits):
    ...
    if(tot_num_bits<=10):
        ...
        for num1 in range(2**tot_num_bits):
            for num2 in range(2**tot_num_bits):
                accurate_sum=ApproxAdders.accurate_adder(num1,num2,tot_num_bits);
                HOAANED_estimate_sum=ApproxAdders.HOAANED_approx(num1,num2,tot_num_bits,inaccurate_bits);
...
def M_HERLOA(tot_num_bits,inaccurate_bits):
    ...
    if(tot_num_bits<=10):
        ...
        for num1 in range(2**tot_num_bits):
            for num2 in range(2**tot_num_bits):
                accurate_sum=ApproxAdders.accurate_adder(num1,num2,tot_num_bits);
                M_HERLOA_estimate_sum=ApproxAdders.M_HERLOA_approx(num1,num2,tot_num_bits,inaccurate_bits);
