    ...
    def generate_verilog_code(user_chosen_options):
        ...
        if type_of_hardware_module == 'MxN Accurate Multiplier':
            verilog_code = VerilogMultiplierCode.accurate_MxN_multiplier(
                multiplicand_bits, multiplier_bits).to_verilog()
            ...
            verilog_code = VerilogMultiplierCode.PAAM01_V_cut_MxN_binary_array_multiplier(
                multiplicand_bits, multiplier_bits, v_cut).to_verilog()
