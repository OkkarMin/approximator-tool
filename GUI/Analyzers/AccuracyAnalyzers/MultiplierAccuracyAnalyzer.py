...
def analyze(user_chosen_options):
    ...
    accurate_multiplier_product = ApproxMultipliers.accurate_array_multiplier(
        multiplier_first_unsigned_number, multiplier_second_unsigned_number,
    ...
    inaccurate_multiplier_accuracy = (
        1 - (abs(accurate_multiplier_product - inaccurate_multiplier_product) /
             accurate_multiplier_product)) * 100

    print_analysis(accurate_multiplier_product, inaccurate_multiplier_product,
                   inaccurate_multiplier_accuracy)


def print_analysis(accurate_multiplier_product, inaccurate_multiplier_product,
                   inaccurate_multiplier_accuracy):
    print("\nAccurate Multiplier Product:\t", accurate_multiplier_product,
          "\n")
    print("\nPAAM01-Vcut Multiplier Product:\t", inaccurate_multiplier_product,
          "\n")
    print("\nPAAM01-Vcut Multiplier Accuracy %:\t",
          inaccurate_multiplier_accuracy, "\n")
