...
def HEAA_Generic(N,k):
    ...
    Add4BitModule.Instance(AndModule,'gate1',ports=[add4bitg0,add4bitinpa0,add4bitinpb0]);
    Add4BitModule.Instance(AndModule,'gate2',ports=[add4bitg1,add4bitinpa1,add4bitinpb1]);
    Add4BitModule.Instance(AndModule,'gate3',ports=[add4bitg2,add4bitinpa2,add4bitinpb2]);
    Add4BitModule.Instance(AndModule,'gate4',ports=[add4bitg3,add4bitinpa3,add4bitinpb3]);

    Add4BitModule.Instance(XorModule,'gate5',ports=[add4bitp0,add4bitinpa0,add4bitinpb0]);
    Add4BitModule.Instance(XorModule,'gate6',ports=[add4bitp1,add4bitinpa1,add4bitinpb1]);
    Add4BitModule.Instance(XorModule,'gate7',ports=[add4bitp2,add4bitinpa2,add4bitinpb2]);
    Add4BitModule.Instance(XorModule,'gate8',ports=[add4bitp3,add4bitinpa3,add4bitinpb3]);

    Add4BitModule.Instance(AndOrModule,'comp1',ports=[add4bitp1,add4bitg0,add4bitg1,add4bitm1]);
    Add4BitModule.Instance(AndOrModule,'comp2',ports=[add4bitm1,add4bitp2,add4bitg2,add4bitm2]);
    Add4BitModule.Instance(AndOrModule,'comp3',ports=[add4bitm2,add4bitp3,add4bitg3,add4bitm3]);
    ...
    Add4BitModule.Instance(AndOrModule,'comp4',ports=[add4bitm6,add4bitinpc0,add4bitm3,add4bitc4]);
    Add4BitModule.Instance(AndOrModule,'comp5',ports=[add4bitm5,add4bitinpc0,add4bitm2,add4bitc3]);
    Add4BitModule.Instance(AndOrModule,'comp6',ports=[add4bitm4,add4bitinpc0,add4bitm1,add4bitc2]);
    Add4BitModule.Instance(AndOrModule,'comp7',ports=[add4bitp0,add4bitinpc0,add4bitg0,add4bitc1]);

    Add4BitModule.Instance(XorModule,'xorg1',ports=[add4bitsum0,add4bitp0,add4bitinpc0]);
    Add4BitModule.Instance(XorModule,'xorg2',ports=[add4bitsum1,add4bitp1,add4bitc1]);
    Add4BitModule.Instance(XorModule,'xorg3',ports=[add4bitsum2,add4bitp2,add4bitc2]);
    Add4BitModule.Instance(XorModule,'xorg4',ports=[add4bitsum3,add4bitp3,add4bitc3]);
    ...
    if(((N-k)%4)==3):
        ...
        Add3BitModule.Instance(AndModule,'gate1',ports=[add3bitg0,add3bitinpa0,add3bitinpb0]);
        Add3BitModule.Instance(AndModule,'gate2',ports=[add3bitg1,add3bitinpa1,add3bitinpb1]);
        Add3BitModule.Instance(AndModule,'gate3',ports=[add3bitg2,add3bitinpa2,add3bitinpb2]);

        Add3BitModule.Instance(XorModule,'gate5',ports=[add3bitp0,add3bitinpa0,add3bitinpb0]);
        Add3BitModule.Instance(XorModule,'gate6',ports=[add3bitp1,add3bitinpa1,add3bitinpb1]);
        Add3BitModule.Instance(XorModule,'gate7',ports=[add3bitp2,add3bitinpa2,add3bitinpb2]);

        Add3BitModule.Instance(AndOrModule,'comp1',ports=[add3bitp1,add3bitg0,add3bitg1,add3bitm1]);
        Add3BitModule.Instance(AndOrModule,'comp2',ports=[add3bitm1,add3bitp2,add3bitg2,add3bitm2]);


        Add3BitModule.Instance(AndModule,'and1',ports=[add3bitm4,add3bitp1,add3bitp0]);
        Add3BitModule.Instance(AndModule,'and2',ports=[add3bitm5,add3bitp2,add3bitm4]);

        Add3BitModule.Instance(AndOrModule,'comp5',ports=[add3bitm5,add3bitinpc0,add3bitm2,add3bitc3]);
        Add3BitModule.Instance(AndOrModule,'comp6',ports=[add3bitm4,add3bitinpc0,add3bitm1,add3bitc2]);
        Add3BitModule.Instance(AndOrModule,'comp7',ports=[add3bitp0,add3bitinpc0,add3bitg0,add3bitc1]);

        Add3BitModule.Instance(XorModule,'xorg1',ports=[add3bitsum0,add3bitp0,add3bitinpc0]);
        Add3BitModule.Instance(XorModule,'xorg2',ports=[add3bitsum1,add3bitp1,add3bitc1]);
        Add3BitModule.Instance(XorModule,'xorg3',ports=[add3bitsum2,add3bitp2,add3bitc2]);
        ...
        Add2BitModule.Instance(AndModule,'gate1',ports=[add2bitg0,add2bitinpa0,add2bitinpb0]);
        Add2BitModule.Instance(AndModule,'gate2',ports=[add2bitg1,add2bitinpa1,add2bitinpb1]);

        Add2BitModule.Instance(XorModule,'gate5',ports=[add2bitp0,add2bitinpa0,add2bitinpb0]);
        Add2BitModule.Instance(XorModule,'gate6',ports=[add2bitp1,add2bitinpa1,add2bitinpb1]);

        Add2BitModule.Instance(AndOrModule,'comp1',ports=[add2bitp1,add2bitg0,add2bitg1,add2bitm1]);

        Add2BitModule.Instance(AndModule,'and1',ports=[add2bitm2,add2bitp1,add2bitp0]);

        Add2BitModule.Instance(AndOrModule,'comp6',ports=[add2bitm2,add2bitinpc0,add2bitm1,add2bitc2]);
        Add2BitModule.Instance(AndOrModule,'comp7',ports=[add2bitp0,add2bitinpc0,add2bitg0,add2bitc1]);

        Add2BitModule.Instance(XorModule,'xorg1',ports=[add2bitsum0,add2bitp0,add2bitinpc0]);
        Add2BitModule.Instance(XorModule,'xorg2',ports=[add2bitsum1,add2bitp1,add2bitc1]);
        ...
        Add1BitModule.Instance(AndModule,'gate1',ports=[add1bitg0,add1bitinpa0,add1bitinpb0]);
        Add1BitModule.Instance(XorModule,'gate5',ports=[add1bitp0,add1bitinpa0,add1bitinpb0]);
        Add1BitModule.Instance(AndOrModule,'comp7',ports=[add1bitp0,add1bitinpc0,add1bitg0,add1bitc1]);
        Add1BitModule.Instance(XorModule,'xorg1',ports=[add1bitsum0,add1bitp0,add1bitinpc0]);
...
##    Adder.Instance(AndModule,'t13',ports=[res[9],w3,w2]);
    ...
    if(temp<N):
        if((N-k)%4==1):
            ...
            exec("Adder.Instance(Add1BitModule,'cla%d',ports=[a[k],b[k],w1,cout%d,res[k]]);" % (cla_count,temp));
            temp=temp+4;
            #Adder.Instance(Add1BitModule,('cla'+str(cla_count)),ports=[a[k],b[k],w1,cout1,res[k]]);
        elif((N-k)%4==2):
            cla_count=cla_count+1;
            exec("Adder.Instance(Add2BitModule,'cla%d',ports=[a[k+1],a[k],b[k+1],b[k],w1,cout%d,res[k+1],res[k]]);" % (cla_count,temp));
            temp=temp+4;
            #Adder.Instance(Add2BitModule,('cla'+str(cla_count)),ports=[a[k+1],a[k],b[k+1],b[k],w1,cout1,res[k+1],res[k]]);
        elif((N-k)%4==3):
            cla_count=cla_count+1;
            exec("Adder.Instance(Add3BitModule,'cla%d',ports=[a[k+2],a[k+1],a[k],b[k+2],b[k+1],b[k],w1,cout%d,res[k+2],res[k+1],res[k]]);" % (cla_count,temp));
            temp=temp+4;
...
##    Adder.Instance(Add2BitModule,'cla1',ports=[a[11],a[10],b[11],b[10],w1,cout12,res[11],res[10]]);
        ...
        while(temp<N):
            cla_count=cla_count+1;
            exec("Adder.Instance(Add4BitModule,'cla%d',ports=[a[temp-1],a[temp-2],a[temp-3],a[temp-4],b[temp-1],b[temp-2], \
                 b[temp-3],b[temp-4],cout%d,cout%d,res[temp-1],res[temp-2],res[temp-3],res[temp-4]]);" %(cla_count,(temp-4),temp));
            temp=temp+4;
...
##    Adder.Instance(Add4BitModule,'cla5',ports=[a[27],a[26],a[25],a[24],b[27],b[26],b[25],b[24],cout24,cout28,res[27],res[26],res[25],res[24]]);
        cla_count=cla_count+1;
        exec("Adder.Instance(Add4BitModule,'cla%d',ports=[a[temp-1],a[temp-2],a[temp-3],a[temp-4],b[temp-1],b[temp-2], \
             b[temp-3],b[temp-4],cout%d,res[temp],res[temp-1],res[temp-2],res[temp-3],res[temp-4]]);" %(cla_count,(temp-4)));
...
##    Adder.Instance(Add4BitModule,'cla6',ports=[a[31],a[30],a[29],a[28],b[31],b[30],b[29],b[28],cout28,res[32],res[31],res[30],res[29],res[28]]);
        ...
        if((N-k)%4==1):
            Adder.Instance(Add1BitModule,'cla1',ports=[a[k],b[k],w1,res[k+1],res[k]]);
        elif((N-k)%4==2):
            Adder.Instance(Add2BitModule,'cla1',ports=[a[k+1],a[k],b[k+1],b[k],w1,res[k+2],res[k+1],res[k]]);
        elif((N-k)%4==3):
            Adder.Instance(Add3BitModule,'cla1',ports=[a[k+2],a[k+1],a[k],b[k+2],b[k+1],b[k],w1,res[k+3],res[k+2],res[k+1],res[k]]);
        else:
            Adder.Instance(Add4BitModule,'cla1',ports=[a[k+3],a[k+2],a[k+1],a[k],b[k+3],b[k+2], \
                 b[k+1],b[k],w1,res[k+4],res[k+3],res[k+2],res[k+1],res[k]]);
...
##    Adder.Instance(OrModule,'t8',ports=[res[9],n5,n6]);
    ...
    if(temp<N):
        if((N-k)%4==1):
            cla_count=cla_count+1;
            exec("Adder.Instance(Add1BitModule,'cla%d',ports=[a[k],b[k],n1,cout%d,res[k]]);" % (cla_count,temp));
            temp=temp+4;
            #Adder.Instance(Add1BitModule,('cla'+str(cla_count)),ports=[a[k],b[k],n1,cout1,res[k]]);
        elif((N-k)%4==2):
            cla_count=cla_count+1;
            exec("Adder.Instance(Add2BitModule,'cla%d',ports=[a[k+1],a[k],b[k+1],b[k],n1,cout%d,res[k+1],res[k]]);" % (cla_count,temp));
            temp=temp+4;
            #Adder.Instance(Add2BitModule,('cla'+str(cla_count)),ports=[a[k+1],a[k],b[k+1],b[k],n1,cout1,res[k+1],res[k]]);
        elif((N-k)%4==3):
            cla_count=cla_count+1;
            exec("Adder.Instance(Add3BitModule,'cla%d',ports=[a[k+2],a[k+1],a[k],b[k+2],b[k+1],b[k],n1,cout%d,res[k+2],res[k+1],res[k]]);" % (cla_count,temp));
            temp=temp+4;
...
##    Adder.Instance(Add4BitModule,'cla6',ports=[a[31],a[30],a[29],a[28],b[31],b[30],b[29],b[28],cout28,res[32],res[31],res[30],res[29],res[28]]);
        ...
        if((N-k)%4==1):
            Adder.Instance(Add1BitModule,'cla1',ports=[a[k],b[k],n1,res[k+1],res[k]]);
        elif((N-k)%4==2):
            Adder.Instance(Add2BitModule,'cla1',ports=[a[k+1],a[k],b[k+1],b[k],n1,res[k+2],res[k+1],res[k]]);
        elif((N-k)%4==3):
            Adder.Instance(Add3BitModule,'cla1',ports=[a[k+2],a[k+1],a[k],b[k+2],b[k+1],b[k],n1,res[k+3],res[k+2],res[k+1],res[k]]);
        else:
            Adder.Instance(Add4BitModule,'cla1',ports=[a[k+3],a[k+2],a[k+1],a[k],b[k+3],b[k+2], \
                 b[k+1],b[k],n1,res[k+4],res[k+3],res[k+2],res[k+1],res[k]]);
...
##    Adder.Instance(OrModule,'t7',ports=[res[9],n5,n1]);
    ...
    if(temp<N):
        if((N-k)%4==1):
            cla_count=cla_count+1;
            exec("Adder.Instance(Add1BitModule,'cla%d',ports=[a[k],b[k],n2,cout%d,res[k]]);" % (cla_count,temp));
            temp=temp+4;
            #Adder.Instance(Add1BitModule,('cla'+str(cla_count)),ports=[a[k],b[k],n2,cout1,res[k]]);
        elif((N-k)%4==2):
            cla_count=cla_count+1;
            exec("Adder.Instance(Add2BitModule,'cla%d',ports=[a[k+1],a[k],b[k+1],b[k],n2,cout%d,res[k+1],res[k]]);" % (cla_count,temp));
            temp=temp+4;
            #Adder.Instance(Add2BitModule,('cla'+str(cla_count)),ports=[a[k+1],a[k],b[k+1],b[k],n2,cout1,res[k+1],res[k]]);
        elif((N-k)%4==3):
            cla_count=cla_count+1;
            exec("Adder.Instance(Add3BitModule,'cla%d',ports=[a[k+2],a[k+1],a[k],b[k+2],b[k+1],b[k],n2,cout%d,res[k+2],res[k+1],res[k]]);" % (cla_count,temp));
            temp=temp+4;
...
##    Adder.Instance(Add4BitModule,'cla6',ports=[a[31],a[30],a[29],a[28],b[31],b[30],b[29],b[28],cout28,res[32],res[31],res[30],res[29],res[28]]);
        ...
        if((N-k)%4==1):
            Adder.Instance(Add1BitModule,'cla1',ports=[a[k],b[k],n2,res[k+1],res[k]]);
        elif((N-k)%4==2):
            Adder.Instance(Add2BitModule,'cla1',ports=[a[k+1],a[k],b[k+1],b[k],n2,res[k+2],res[k+1],res[k]]);
        elif((N-k)%4==3):
            Adder.Instance(Add3BitModule,'cla1',ports=[a[k+2],a[k+1],a[k],b[k+2],b[k+1],b[k],n2,res[k+3],res[k+2],res[k+1],res[k]]);
        else:
            Adder.Instance(Add4BitModule,'cla1',ports=[a[k+3],a[k+2],a[k+1],a[k],b[k+3],b[k+2], \
                 b[k+1],b[k],n2,res[k+4],res[k+3],res[k+2],res[k+1],res[k]]);
...
def M_HERLOA_Generic(N,k):
    ...
    w1=Adder.Wire('w1');
    if k>3:                        
        w2=Adder.Wire('w2');        #NOTE- w2 Wire is not used if number of inaccurate bits (k) = 3
...
##    res[5].assign(1);  
    ...
    if(k>3):                                        
        Adder.Instance(OrModule,'g2',ports=[w2,a[k-4],b[k-4]]);     #NOTE- Not used if number of inaccurate bits (k) <= 3 as a[k-4]=a[-1] for k=3
                                                                    # No need to worry about k<=2 as our tool is used to generate verilog code only for k>=3                        
    Adder.Instance(OrModule,'e1',ports=[res[k-3],n3,w1]);
    if(k>3):
        Adder.Instance(OrModule,'e2',ports=[res[k-4],n3,w2]);       #NOTE- Not used if number of inaccurate bits (k) <= 3 as res[k-4]=res[-1] for k=3
                                                                    # No need to worry about k<=2 as our tool is used to generate verilog code only for k>=3
...
##    Adder.Instance(AndModule,'t9',ports=[w12,a[9],b[9]]);
    ...
    if(temp<N):
        if((N-k)%4==1):
            cla_count=cla_count+1;
            exec("Adder.Instance(Add1BitModule,'cla%d',ports=[a[k],b[k],w12,cout%d,res[k]]);" % (cla_count,temp));
            temp=temp+4;
            #Adder.Instance(Add1BitModule,('cla'+str(cla_count)),ports=[a[k],b[k],w12,cout1,res[k]]);
        elif((N-k)%4==2):
            cla_count=cla_count+1;
            exec("Adder.Instance(Add2BitModule,'cla%d',ports=[a[k+1],a[k],b[k+1],b[k],w12,cout%d,res[k+1],res[k]]);" % (cla_count,temp));
            temp=temp+4;
            #Adder.Instance(Add2BitModule,('cla'+str(cla_count)),ports=[a[k+1],a[k],b[k+1],b[k],w12,cout1,res[k+1],res[k]]);
        elif((N-k)%4==3):
            cla_count=cla_count+1;
            exec("Adder.Instance(Add3BitModule,'cla%d',ports=[a[k+2],a[k+1],a[k],b[k+2],b[k+1],b[k],w12,cout%d,res[k+2],res[k+1],res[k]]);" % (cla_count,temp));
            temp=temp+4;
...
##    Adder.Instance(Add4BitModule,'cla6',ports=[a[31],a[30],a[29],a[28],b[31],b[30],b[29],b[28],cout28,res[32],res[31],res[30],res[29],res[28]]);
        ...
        if((N-k)%4==1):
            Adder.Instance(Add1BitModule,'cla1',ports=[a[k],b[k],w12,res[k+1],res[k]]);
        elif((N-k)%4==2):
            Adder.Instance(Add2BitModule,'cla1',ports=[a[k+1],a[k],b[k+1],b[k],w12,res[k+2],res[k+1],res[k]]);
        elif((N-k)%4==3):
            Adder.Instance(Add3BitModule,'cla1',ports=[a[k+2],a[k+1],a[k],b[k+2],b[k+1],b[k],w12,res[k+3],res[k+2],res[k+1],res[k]]);
        else:
            Adder.Instance(Add4BitModule,'cla1',ports=[a[k+3],a[k+2],a[k+1],a[k],b[k+3],b[k+2], \
                 b[k+1],b[k],w12,res[k+4],res[k+3],res[k+2],res[k+1],res[k]]);
...
def M_HERLOA_32_bits_10_inaccurate():
    ...
    Adder.Instance(Add2BitModule,'cla1',ports=[a[11],a[10],b[11],b[10],w12,cout12,res[11],res[10]]);
    Adder.Instance(Add4BitModule,'cla2',ports=[a[15],a[14],a[13],a[12],b[15],b[14],b[13],b[12],cout12,cout16,res[15],res[14],res[13],res[12]]);
    Adder.Instance(Add4BitModule,'cla3',ports=[a[19],a[18],a[17],a[16],b[19],b[18],b[17],b[16],cout16,cout20,res[19],res[18],res[17],res[16]]);
    Adder.Instance(Add4BitModule,'cla4',ports=[a[23],a[22],a[21],a[20],b[23],b[22],b[21],b[20],cout20,cout24,res[23],res[22],res[21],res[20]]);
    Adder.Instance(Add4BitModule,'cla5',ports=[a[27],a[26],a[25],a[24],b[27],b[26],b[25],b[24],cout24,cout28,res[27],res[26],res[25],res[24]]);
